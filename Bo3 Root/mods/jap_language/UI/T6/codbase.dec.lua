...
CoD.IsHiddenDLC = function ( f6_arg0 )
	...
	local f6_local1 = CoD.DLCPackFromBit[f6_arg0]
	if f6_local1 then
		f6_local1 = f6_local0 and not CoD.ProductIsKnown[f6_arg0]
	end
	return f6_local1
end
	...
	for f7_local12, f7_local13 in pairs( CoD.ProductFromBit ) do
		for f7_local9, f7_local10 in pairs( f7_local13.products ) do
			...
			if CoD.ProductIsKnown[f7_local9] then
				f7_local13.known = f7_local13.known
			end
...
CoD.IsClientMissingDLC = function ( f11_arg0, f11_arg1 )
	if Engine.IsZombiesGame() then
		...
		f11_arg0 = LuaUtils.UpdateZMDLCBits( f11_arg0 )
		f11_arg1 = LuaUtils.UpdateZMDLCBits( f11_arg1 )
	end
...
CoD.yellow.b = 1
CoD.yellowGlow = {}
CoD.yellowGlow.r = 0.68
CoD.yellowGlow.g = 0.55
CoD.yellowGlow.b = 1
CoD.green = {}
CoD.green.r = 0.42
CoD.green.g = 0.68
...
CoD.BOIIOrange.b = 0
CoD.playerYellow = {}
CoD.playerYellow.r = 0.15
CoD.playerYellow.g = 0.55
CoD.playerYellow.b = 1
CoD.playerBlue = {}
...
CoD.RTSColors.yellow.r = 0.15
CoD.RTSColors.yellow.g = 0.55
CoD.RTSColors.yellow.b = 1
CoD.MenuTitleColor = {}
...
CoD.isXuidPrivatePartyHost = function ( f51_arg0 )
	local f51_local0 = Engine.InPrivateParty()
	if f51_local0 then
		f51_local0 = Engine.IsXuidPrivatePartyHost( f51_arg0 ) == true
	end
	return f51_local0
end
